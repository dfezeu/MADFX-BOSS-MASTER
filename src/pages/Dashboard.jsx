    ...
    { 
     ...
     { 
       ...
       items: [
         ...
         { id: "madfxbosspc", label: "MADFX BOSS PC" },
         { id: "maxai", label: "MAXAI.IO" },
         { id: "bonus", label: "Sign Up Bonus" }
       ]
     },
     { 
       id: "legal", 
    ...
    <div style={{ background: "#050510", minHeight: "100vh", fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px", padding: "15px 0", position: "relative" }}>
         ...
         <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
           ...
           <div style={{ display: "flex", gap: "10px" }}>
             <a href="https://twitter.com/madfxboss" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "5px", padding: "6px 10px", background: "#1d9bf0", color: "white", borderRadius: "6px", fontSize: "11px", fontWeight: "500" }}>
               <span>🐦</span>
               <span>Twitter</span>
             </a>
             <a href="https://discord.gg/madfxboss" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "5px", padding: "6px 10px", background: "#5865f2", color: "white", borderRadius: "6px", fontSize: "11px", fontWeight: "500" }}>
               <span>💬</span>
               <span>Discord</span>
             </a>
             <a href="https://instagram.com/madfxboss" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "5px", padding: "6px 10px", background: "#e1306c", color: "white", borderRadius: "6px", fontSize: "11px", fontWeight: "500" }}>
               <span>📸</span>
               <span>Instagram</span>
             </a>
             <a href="https://linkedin.com/company/madfxboss" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "5px", padding: "6px 10px", background: "#0a66c2", color: "white", borderRadius: "6px", fontSize: "11px", fontWeight: "500" }}>
               <span>💼</span>
               <span>LinkedIn</span>
             </a>
           </div>
      ...
      <main style={{ padding: "20px", maxWidth: "1600px", margin: "0 auto" }}>
        ...
        {activeTab === "backoffice" && <BackOfficeCEO />}
         ...
         {activeTab === "madfxbosspc" && <MadfxBossPcLanding />}
         
         {activeTab === "maxai" && <MaxaiIoLanding />}
         ...
         {activeTab === "mining" && <MiningOptions />}
